...
\begin{solution}
On cherche la valeure  \emph{t} (si elle existe) pour laquelle les 3 composantes  \emph{X, Y} et  \emph{Z} des 2 fonctions vectorielles sont égaux (collision). Commençons par trouver une valeure de  \emph{t} qui satisfait cette condition pour la composante \emph{X}:
